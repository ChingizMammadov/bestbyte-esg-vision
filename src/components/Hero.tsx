...
export const Hero = () => (
  ...
  >
    {/* Background Pattern */}
    <div className="absolute inset-0 bg-[radial-gradient(circle_at_50%_50%,rgba(16,185,129,0.05),transparent_50%)] dark:bg-[radial-gradient(circle_at_50%_50%,rgba(76,175,80,0.1),transparent_50%)]" aria-hidden="true"></div>
    <div className="absolute top-0 left-0 w-full h-full bg-grid-pattern opacity-5 dark:opacity-10" aria-hidden="true"></div>
    
    {/* Dark mode gradient overlay */}
    <div className="absolute inset-0 bg-gradient-to-b from-transparent via-transparent to-gray-900/10 dark:to-gray-900/30" aria-hidden="true"></div>
    ...
    <div className="container relative flex flex-col lg:flex-row items-center gap-12 lg:gap-16">
      <div className="flex-1 text-center lg:text-left animate-fade-in">
        ...
        <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-emerald-100 dark:bg-emerald-900/30 border border-emerald-200 dark:border-emerald-700 text-emerald-800 dark:text-emerald-300 text-sm font-medium mb-6 animate-scale-in backdrop-blur-sm">
          <div className="w-2 h-2 bg-emerald-500 dark:bg-emerald-400 rounded-full animate-pulse" aria-hidden="true"></div>
        ...
        <div className="flex flex-col sm:flex-row items-center gap-4 text-sm text-gray-500 dark:text-gray-400" role="group" aria-label="Trust indicators">
          <div className="flex items-center gap-2">
            <div className="flex -space-x-2" role="group" aria-label="Customer avatars">
              ...
              <div className="w-8 h-8 rounded-full bg-blue-100 dark:bg-blue-900/50 border-2 border-white dark:border-gray-700 flex items-center justify-center text-blue-600 dark:text-blue-400 font-semibold text-xs" aria-label="Customer B">B</div>
              <div className="w-8 h-8 rounded-full bg-purple-100 dark:bg-purple-900/50 border-2 border-white dark:border-gray-700 flex items-center justify-center text-purple-600 dark:text-purple-400 font-semibold text-xs" aria-label="Customer C">C</div>
              <div className="w-8 h-8 rounded-full bg-gray-100 dark:bg-gray-700 border-2 border-white dark:border-gray-600 flex items-center justify-center text-gray-600 dark:text-gray-300 font-semibold text-xs" aria-label="More customers">+</div>
            </div>
            <span>Join 500+ companies</span>
          </div>
          <div className="hidden sm:block w-1 h-1 bg-gray-300 dark:bg-gray-600 rounded-full" aria-hidden="true"></div>
          <span role="img" aria-label="4.9 out of 5 star rating">⭐ 4.9/5 customer rating</span>
          <div className="hidden sm:block w-1 h-1 bg-gray-300 dark:bg-gray-600 rounded-full" aria-hidden="true"></div>
          <span role="img" aria-label="Security certified">🔒 SOC 2 & GDPR compliant</span>
        </div>
      </div>
      ...
      <div className="flex-1 flex justify-center lg:justify-end animate-scale-in">
        <div className="relative">
          <div className="absolute -inset-4 bg-gradient-to-r from-emerald-400 to-teal-400 dark:from-emerald-500 dark:to-teal-500 rounded-3xl blur-2xl opacity-20 dark:opacity-30 animate-pulse" aria-hidden="true"></div>
          <img
          ...
          {/* Floating Cards */}
          <div className="absolute -top-4 -left-4 bg-white dark:bg-gray-800 rounded-2xl shadow-lg dark:shadow-gray-900/30 p-4 animate-float border border-gray-100 dark:border-gray-700" role="img" aria-label="Carbon neutral badge">
            <div className="flex items-center gap-3">
              <div className="w-3 h-3 bg-green-500 dark:bg-green-400 rounded-full" aria-hidden="true"></div>
              <span className="text-sm font-medium text-gray-700 dark:text-gray-300">Carbon Neutral</span>
            </div>
          </div>
          
          <div className="absolute -bottom-4 -right-4 bg-white dark:bg-gray-800 rounded-2xl shadow-lg dark:shadow-gray-900/30 p-4 animate-float border border-gray-100 dark:border-gray-700" style={{ animationDelay: '1s' }} role="img" aria-label="ESG score of 98%">
            <div className="flex items-center gap-3">
