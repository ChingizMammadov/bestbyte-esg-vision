...
export const Testimonials = () => (
  <section className="py-16 md:py-20 bg-gradient-to-br from-gray-50 via-emerald-50 to-teal-50 dark:from-gray-800/80 dark:via-emerald-800/30 dark:to-teal-900/40 relative overflow-hidden">
    ...
    <div className="container relative">
      ...
      <div className="text-center mb-12">
        ...
        <h3 className="text-3xl md:text-4xl font-bold mb-4 text-gray-900 dark:text-white font-montserrat">
          Trusted by{" "}
        ...
        <p className="text-lg text-gray-600 dark:text-gray-300 max-w-2xl mx-auto leading-relaxed">
          Join hundreds of companies already transforming their ESG reporting
          with BestByte
        </p>
      </div>
      ...
      <div className="mb-12">
        <p className="text-center text-xs text-gray-600 dark:text-gray-400 mb-6 font-medium tracking-wide">
        ...
        <div className="flex flex-wrap justify-center items-center gap-6 opacity-80">
          {companyLogos.map((company, index) => (
            <div
              key={company.name}
              className="flex items-center justify-center w-12 h-12 bg-white dark:bg-gray-800 rounded-lg shadow-sm border border-gray-200 dark:border-gray-700 hover:shadow-md transition-shadow duration-300 animate-fade-in opacity-0"
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6 max-w-5xl mx-auto">
        {testimonials.map((testimonial, index) => (
          <div
            ...
            className="group relative bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-2xl p-6 shadow-lg hover:shadow-xl transition-all duration-500 hover:-translate-y-1 animate-fade-in opacity-0"
          ...
          >
            ...
            {/* Quote */}
            <blockquote className="text-gray-700 dark:text-gray-400 mb-6 leading-relaxed italic text-sm">
              "{testimonial.quote}"
            </blockquote>
