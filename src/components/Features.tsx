...
export const Features = () => (
  <section id="features" className="py-24 md:py-32 bg-white relative overflow-hidden">
    ...
    <div className="absolute top-0 left-1/2 transform -translate-x-1/2 w-96 h-96 bg-gradient-to-r from-emerald-100 to-teal-100 rounded-full blur-3xl opacity-30"></div>
    ...
    <div className="container relative">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mb-20">
        {features.map((feature, index) => (
          <div 
            key={feature.name} 
            className="group relative bg-white border border-gray-200 rounded-2xl p-8 shadow-lg hover:shadow-2xl transition-all duration-500 hover:-translate-y-2 animate-fade-in"
      ...
      {/* Additional Features */}
      <div className="bg-gradient-to-r from-gray-50 to-emerald-50 rounded-3xl p-8 md:p-12">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
          {additionalFeatures.map((feature, index) => (
            <div 
              ...
              style={{ animationDelay: `${index * 100}ms` }}
            >
              <div className="w-12 h-12 rounded-xl bg-white shadow-md flex items-center justify-center mx-auto mb-4 group-hover:scale-110 transition-transform duration-300 text-emerald-600">
                {feature.icon}
              </div>
